...
const directions = ["walk_down", 1, "walk_down", 1, "walk_right", 1, "walk_right", 1,
			"walk_up", 1, "walk_up", 1, "walk_right", -1, "walk_right", -1]

const idles = ["idle_down", 1, "idle_down", 1, "idle_right", 1, "idle_right", 1,
			"idle_up", 1, "idle_up", 1, "idle_right", -1, "idle_right", -1]

const speaks = ["idle_down", 1, "idle_down", 1, "idle_right", 1, "idle_right", 1,
"idle_up", 1, "idle_up", 1, "idle_right", -1, "idle_right", -1]

const in_chair = ["in_chair", 1]